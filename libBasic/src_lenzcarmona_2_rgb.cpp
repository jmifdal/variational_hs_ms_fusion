...
int main(int argc, char **argv)
{
    ...
    if(!parsecmdline("src_lenzcarmona_2_rgb", "Transform from (L,C1,C2) - LenzCarmona to RGB coordinates", argc, argv, options, parameters))
        return EXIT_FAILURE;
    ...
    libUSTG::fiLenzCarmona2Rgb(output.v(0), output.v(1), output.v(2), L.v(), C1.v(), C2.v(), L.w()*L.h());
